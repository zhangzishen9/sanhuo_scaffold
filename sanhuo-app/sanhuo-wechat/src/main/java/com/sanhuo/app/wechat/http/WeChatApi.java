package com.sanhuo.app.wechat.http;

import com.sanhuo.app.http.annotation.HttpClient;
import com.sanhuo.app.wechat.response.WechatTokenResponse;
...
public interface WeChatApi {
    ...
    void login(@RequestParam("grant_type") String grantType, @RequestParam("js_code") String jsCode, String appid, String secret);
}
